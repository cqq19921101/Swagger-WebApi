...
namespace MesInterface
{
    public class DAL_STD : DAL
    {
        ...
        public DataSet QueryData(string sn, string line, string process, string terminal)
        {
            string sql = "SAJET.USP_MESINTERFACE_QUERYSTD";
            OracleParameter[] ops = {
                        new OracleParameter("v_sn",OracleDbType.Varchar2,0,sn,ParameterDirection.Input),
                        new OracleParameter("v_line",OracleDbType.Varchar2,0,line,ParameterDirection.Input),
                        new OracleParameter("v_process",OracleDbType.Varchar2,0,process,ParameterDirection.Input),
                        new OracleParameter("v_terminal",OracleDbType.Varchar2,0,terminal,ParameterDirection.Input),
