...
namespace WindowFramework
{
    public class DAL : Liteon.Mes.Db.Oracle
    {
        ...
        {
            string sql = "SELECT a.EMP_NO,a.EMP_ID,a.EMP_NAME,b.DEPT_NAME,a.FACTORY_ID FROM SAJET.SYS_EMP a,SAJET.SYS_DEPT b WHERE a.EMP_ID="+uid+" AND a.DEPT_ID=b.DEPT_ID";
